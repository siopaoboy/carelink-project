    ...
    try {
      ...
      try {
        ...
        const legacyEmail = legacy
          ? (JSON.parse(legacy).email as string | undefined)
          : undefined;
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background">
      <div className="w-full max-w-md p-8 space-y-6 bg-background rounded">
        ...
        <p className="text-center text-lg font-semibold mb-4">
          Welcome Back to Child Care Search!
        </p>
        <form className="space-y-4" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="w-full py-2 font-bold text-primary-foreground bg-primary rounded hover:bg-primary/90"
          >
            Sign in
          </button>
        </form>
