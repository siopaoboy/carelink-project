...
const applications = [
  {
    ...
    notes:
      "Application submitted successfully. Provider has confirmed receipt and is reviewing.",
    nextSteps:
      "Wait for provider to schedule interview or request additional information.",
  },
  {
    id: 2,
    providerId: 2,
    ...
    notes:
      "Interview completed. Currently on waitlist - position #2. Provider expects opening in March.",
  ...
  },
  {
    ...
    notes:
      "Congratulations! Your application has been accepted. Enrollment paperwork required.",
  ...
  },
  {
    ...
    notes:
      "Application not selected. Provider cited age group mismatch as reason.",
...
export default function DashboardPage() {
        ...
        if (email) {
          ...
          if (supaVerified) {
            ...
            if (!rec?.verified) {
              ...
              router.replace(
                `/verify-sent?email=${encodeURIComponent(
                  email
  ...
  const statusCounts = {
    ...
    "in-review": applications.filter((app) => app.status === "in-review")
      .length,
    waitlisted: applications.filter((app) => app.status === "waitlisted")
      .length,
            ...
            <CardContent className="space-y-3">
              ...
              {showMap ? (
                ...
                <div className="rounded border p-4 text-sm text-muted-foreground">
                  List view will show nearby providers. Use Search to see full
                  results.
                </div>
              )}
            </CardContent>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Track your childcare applications and their progress
              </p>
            </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-sm text-muted-foreground">
                              ...
                              of {application.timeline.length} steps
                            </span>
                          </div>
                          <Progress
                            value={getTimelineProgress(application.timeline)}
                            className="h-2"
                          />
                        </div>
                          ...
                          application.waitlistPosition && (
                            <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                              ...
                              <p className="text-xs text-orange-600 mt-1">
                                You're #{application.waitlistPosition} in line.
                          ...
                          application.startDate && (
                            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                              <p className="text-sm font-medium text-green-800">
                                Congratulations! Start Date:{" "}
                                {new Date(
                                  application.startDate
                                ).toLocaleDateString()}
                              </p>
                              <p className="text-xs text-green-600 mt-1">
                                Complete enrollment paperwork to secure your
                                spot.
                              </p>
                            </div>
                          )}
                          ...
                          application.rejectionReason && (
                            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                              ...
                              <p className="text-xs text-red-600 mt-1">
                                Consider other providers or reapply later.
                              </p>
                            </div>
                          )}
                        ...
                        <div className="flex gap-3 pt-2">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              (window.location.href = `/provider/${application.providerId}`)
                            }
                          >
                            View Provider
                          </Button>
